...
export default function RegisterPage(){
  ...
  return (
    <main className="mx-auto max-w-sm p-6 space-y-4">
      <h1 className="text-xl font-semibold">Web Portal Account Setup</h1>
      <p className="text-sm opacity-80">
        This route is for optional web portal onboarding. Patient primary experience is mobile.
      </p>
      <form className="space-y-3" onSubmit={submit}>
        ...
        <button disabled={loading} className="border px-3 py-1 rounded w-full">{loading?'Creating...':'Create portal account'}</button>
      </form>
